const NOMOR_WA_KAMU = "6289526797014"; 
        const tanggalMulaiSuka = new Date(2026, 0, 1, 0, 0); 
        ...
        // Mulai petualangan dari Halaman 1 ke Halaman 2 dengan efek Loading Bar
        ...
        /* BARU: Fungsi Sistem Transisi Loading Box Panjang Pink Putih */
        function jalankanTransisiLoading(idHalamanSekarang, idHalamanTujuan) {
            ...
            // Jalankan animasi bar isi pink
            setTimeout(() => {
                bar.style.width = '100%';
            }, 50);

            // Setelah 1.5 detik loading penuh, ganti layer halaman
            setTimeout(() => {
        ...
        function updateCountdown() {
            ...
            document.getElementById('waktuMemendam').innerText = `Aku udah suka kamu selama: ${hari} Hari, ${jam} Jam, ${menit} Menit, ${detik} Detik ⌛❤️`;
        }
        ...
        function pemicuEfekLove() {
            ...
            // Gabungan Efek Love Titik + Transisi Loading Box ke Form Resmi
            setTimeout(() => {
        ...
        function terimaCinta() {
            ...
            // Menghilangkan gambar atas di layer form agar fokus ke isian
            const frameFoto = document.querySelector('.frame-foto-akhir');
            if(frameFoto) frameFoto.style.display = 'none';
            ...
            kotakFinal.innerHTML = `
                <div style="animation: popIn 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275);">
                    ...
                    <div class="form-wa">
                        ...
                        <textarea id="perasaan" rows="2" placeholder="Contoh: Bahagia bangeeet, deg-degan juga..."></textarea>
                        
                        <label>Nanti kita first date ke mana? 🍰🍿</label>
                        <input type="text" id="tempatDate" placeholder="Tulis tempat date impian kamu di sini... ">
                        
                        <button class="btn-kirim-wa" onclick="kirimKeWhatsApp()">Kirim ke WA Aku! 📲</button>
                    </div>

                    <div class="text-tambahan">
                        bungaanyaaa sama barangnya nanti yaaaa 🌸🎁
                    </div>
                </div>
            `;
        ...
        function kirimKeWhatsApp() {
            ...
            const urlWA = "https://wa.me/" + NOMOR_WA_KAMU + "?text=" + encodeURIComponent(teksPesan);
